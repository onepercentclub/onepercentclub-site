...
catalog['If you leave me now...'] = 'Geen account aangevraagd?';
...
catalog['Invalid token, try request a new password again'] = 'Ongeldige link, vraag een nieuw wachtwoord aan.';
...
catalog['Password needs to be at least 6 characters long'] = 'Wachtwoord moet minstens 6 tekens bevatten.';
...
catalog['Pick an item'] = 'Kies een onderdeel';
...
catalog['Unauthorized to connect to Facebook '] = 'We zijn niet gemachtigd om met je Facebook account te verbinden.';
catalog['We\'ve sent a password reset link to your inbox'] = 'We hebben een link om je wachtwoord opnieuw in te stellen verstuurd naar je inbox';
