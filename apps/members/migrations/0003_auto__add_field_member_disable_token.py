...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.disable_token'
        db.add_column(u'members_member', 'disable_token',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.disable_token'
        db.delete_column(u'members_member', 'disable_token')
