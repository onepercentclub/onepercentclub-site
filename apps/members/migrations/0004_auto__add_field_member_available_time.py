...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.available_time'
        db.add_column(u'members_member', 'available_time',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.available_time'
        db.delete_column(u'members_member', 'available_time')
