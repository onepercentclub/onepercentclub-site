...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(MODEL_MAP['user']['table'], 'campaign_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Member.last_name'
        db.alter_column(MODEL_MAP['user']['table'], 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Member.first_name'
        db.alter_column(MODEL_MAP['user']['table'], 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Member.campaign_notifications'
        db.delete_column(MODEL_MAP['user']['table'], 'campaign_notifications')


        # Changing field 'Member.last_name'
        db.alter_column(MODEL_MAP['user']['table'], 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Member.first_name'
        db.alter_column(MODEL_MAP['user']['table'], 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30))
