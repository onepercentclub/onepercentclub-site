...
class BlueBottleUser(AbstractBaseUser, PermissionsMixin):
    ...
    # username = AutoSlugField(_("slug"), max_length=30, unique=True, populate_from=('get_username',), overwrite=True)
    ...
    #     # TODO implement user calculation
    #     return email_name, domain_part = email.strip().rsplit('@', 1)
