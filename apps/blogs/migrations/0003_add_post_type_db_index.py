...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BlogPost', fields ['post_type']
        db.create_index('blogs_blogpost', ['post_type'])


    def backwards(self, orm):
        # Removing index on 'BlogPost', fields ['post_type']
        db.delete_index('blogs_blogpost', ['post_type'])
    ...
    models = {
        ...
        'blogs.blogpost': {
            ...
            'post_type': ('django.db.models.fields.CharField', [], {'max_length': '20', 'db_index': 'True'}),
