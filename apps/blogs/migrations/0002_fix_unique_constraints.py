...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BlogPost', fields ['language']
        db.delete_unique('blogs_blogpost', ['language'])

        # Adding unique constraint on 'BlogPost', fields ['slug', 'language']
        db.create_unique('blogs_blogpost', ['slug', 'language'])


    def backwards(self, orm):
        # Removing unique constraint on 'BlogPost', fields ['slug', 'language']
        db.delete_unique('blogs_blogpost', ['slug', 'language'])

        # Adding unique constraint on 'BlogPost', fields ['language']
        db.create_unique('blogs_blogpost', ['language'])
    ...
    models = {
        ...
        'blogs.blogpost': {
            'Meta': {'unique_together': "(('slug', 'language'),)", 'object_name': 'BlogPost'},
