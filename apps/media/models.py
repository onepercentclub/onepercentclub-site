...
class Album(models.Model):
    ...
    # This is populated from the project slug in legacy and should have the same length
...
class OembedAbstractBase(models.Model):
    ...
    thumbnail_width = models.SmallIntegerField(_("thumbnail width"), blank=True, null=True)
    thumbnail_height = models.SmallIntegerField(_("thumbnail height"), blank=True, null=True)

    provider_name = models.CharField(_("providr name"), blank=True, max_length=255)
    provider_url = models.CharField(_("provider URL"), blank=True, max_length=255)

    author_name = models.CharField(_("author name"), blank=True, max_length=255)
    author_url = models.URLField(_("author URL"), blank=True)
