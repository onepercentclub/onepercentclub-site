...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mchanga_mpesafundraiser', (
            ...
            ('total_amount', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('current_amount', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('payment_count', self.gf('django.db.models.fields.IntegerField')(null=True)),
