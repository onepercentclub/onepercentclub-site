...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MpesaPayment'
        db.create_table(u'mchanga_mpesapayment', (
            ...
            ('currency', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('fundraiser_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('mchanga_account', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('mpesa_id', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('mpesa_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('mpesa_phone', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ...
        db.send_create_signal(u'mchanga', ['MpesaPayment'])


    def backwards(self, orm):
        # Deleting model 'MpesaPayment'
        db.delete_table(u'mchanga_mpesapayment')
