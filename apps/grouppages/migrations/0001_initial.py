...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupPage'
        db.create_table(u'grouppages_grouppage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='group_owner', to=orm['accounts.BlueBottleUser'])),
        ...
        db.send_create_signal(u'grouppages', ['GroupPage'])

        # Adding M2M table for field members on 'GroupPage'
        m2m_table_name = db.shorten_name(u'grouppages_grouppage_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('grouppage', models.ForeignKey(orm[u'grouppages.grouppage'], null=False)),
            ('bluebottleuser', models.ForeignKey(orm[u'accounts.bluebottleuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['grouppage_id', 'bluebottleuser_id'])

        # Adding M2M table for field projects on 'GroupPage'
        m2m_table_name = db.shorten_name(u'grouppages_grouppage_projects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('grouppage', models.ForeignKey(orm[u'grouppages.grouppage'], null=False)),
            ('project', models.ForeignKey(orm[u'projects.project'], null=False))
        ))
        db.create_unique(m2m_table_name, ['grouppage_id', 'project_id'])

        # Adding model 'GroupPageSlide'
        db.create_table(u'grouppages_grouppageslide', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grouppages.GroupPage'])),
        ...
        db.send_create_signal(u'grouppages', ['GroupPageSlide'])


    def backwards(self, orm):
        # Deleting model 'GroupPage'
        db.delete_table(u'grouppages_grouppage')

        # Removing M2M table for field members on 'GroupPage'
        db.delete_table(db.shorten_name(u'grouppages_grouppage_members'))

        # Removing M2M table for field projects on 'GroupPage'
        db.delete_table(db.shorten_name(u'grouppages_grouppage_projects'))

        # Deleting model 'GroupPageSlide'
        db.delete_table(u'grouppages_grouppageslide')
    ...
    models = {
        ...
        u'grouppages.grouppage': {
            'Meta': {'object_name': 'GroupPage'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.BlueBottleUser']", 'symmetrical': 'False'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_owner'", 'to': u"orm['accounts.BlueBottleUser']"}),
        ...
        u'grouppages.grouppageslide': {
            'Meta': {'ordering': "('group', 'sequence')", 'object_name': 'GroupPageSlide'},
            'body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['grouppages.GroupPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
