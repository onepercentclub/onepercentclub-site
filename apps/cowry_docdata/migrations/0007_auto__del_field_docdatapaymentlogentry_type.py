...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocDataPaymentLogEntry.type'
        db.delete_column(u'cowry_docdata_docdatapaymentlogentry', 'type')


    def backwards(self, orm):
        # Adding field 'DocDataPaymentLogEntry.type'
        db.add_column(u'cowry_docdata_docdatapaymentlogentry', 'type',
                      self.gf('django.db.models.fields.CharField')(default='status_change', max_length=15),
                      keep_default=False)
