...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocDataPayment.status'
        db.alter_column(u'cowry_docdata_docdatapayment', 'status', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'DocDataPayment.status'
        db.alter_column(u'cowry_docdata_docdatapayment', 'status', self.gf('django.db.models.fields.CharField')(max_length=25))
