...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocDataWebDirectDirectDebit.bank_account_name'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bank_account_name')

        # Deleting field 'DocDataWebDirectDirectDebit.bank_account_city'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bank_account_city')

        # Deleting field 'DocDataWebDirectDirectDebit.bank_account_number'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bank_account_number')

        # Adding field 'DocDataWebDirectDirectDebit.account_name'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'account_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35),
                      keep_default=False)

        # Adding field 'DocDataWebDirectDirectDebit.account_city'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'account_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35),
                      keep_default=False)

        # Adding field 'DocDataWebDirectDirectDebit.iban'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'iban',
                      self.gf('django_iban.fields.IBANField')(default='', max_length=34),
                      keep_default=False)

        # Adding field 'DocDataWebDirectDirectDebit.bic'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bic',
                      self.gf('django_iban.fields.SWIFTBICField')(default='', max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DocDataWebDirectDirectDebit.bank_account_name'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bank_account_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DocDataWebDirectDirectDebit.bank_account_city'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bank_account_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DocDataWebDirectDirectDebit.bank_account_number'
        db.add_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bank_account_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Deleting field 'DocDataWebDirectDirectDebit.account_name'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'account_name')

        # Deleting field 'DocDataWebDirectDirectDebit.account_city'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'account_city')

        # Deleting field 'DocDataWebDirectDirectDebit.iban'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'iban')

        # Deleting field 'DocDataWebDirectDirectDebit.bic'
        db.delete_column(u'cowry_docdata_docdatawebdirectdirectdebit', 'bic')
