...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocDataPaymentOrder.customer_id'
        db.alter_column(u'cowry_docdata_docdatapaymentorder', 'customer_id', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'DocDataPaymentOrder.customer_id'
        db.alter_column(u'cowry_docdata_docdatapaymentorder', 'customer_id', self.gf('django.db.models.fields.IntegerField')())
