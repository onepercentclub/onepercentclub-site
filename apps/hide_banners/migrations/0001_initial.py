...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Slide'
        db.create_table(u'banners_slide', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Member'])),
        ...
        db.send_create_signal(u'banners', ['Slide'])


    def backwards(self, orm):
        # Deleting model 'Slide'
        db.delete_table(u'banners_slide')
