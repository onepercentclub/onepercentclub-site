...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fund_recurringdirectdebitpayment', (
            ...
            ('manually_process', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table(u'fund_donation', (
            ...
            ('currency', self.gf('django.db.models.fields.CharField')(default='EUR', max_length=3)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Member'], null=True, blank=True)),
        ...
        db.create_table(u'fund_order', (
            ...
            ('order_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
