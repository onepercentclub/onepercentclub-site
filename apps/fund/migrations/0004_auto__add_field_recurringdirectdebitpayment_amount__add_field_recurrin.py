...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecurringDirectDebitPayment.amount'
        db.add_column(u'fund_recurringdirectdebitpayment', 'amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RecurringDirectDebitPayment.currency'
        db.add_column(u'fund_recurringdirectdebitpayment', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecurringDirectDebitPayment.amount'
        db.delete_column(u'fund_recurringdirectdebitpayment', 'amount')

        # Deleting field 'RecurringDirectDebitPayment.currency'
        db.delete_column(u'fund_recurringdirectdebitpayment', 'currency')
