...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fund_voucher', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='vouchers', null=True, to=orm['fund.Order']),
                      keep_default=False)

        # Adding field 'Donation.order'
        db.add_column(u'fund_donation', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='donations', null=True, to=orm['fund.Order']),
                      keep_default=False)

        # Adding field 'Donation.voucher'
        db.add_column(u'fund_donation', 'voucher',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fund.Voucher'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voucher.order'
        db.delete_column(u'fund_voucher', 'order_id')

        # Deleting field 'Donation.order'
        db.delete_column(u'fund_donation', 'order_id')
