...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecurringDirectDebitPayment.iban'
        db.add_column(u'fund_recurringdirectdebitpayment', 'iban',
                      self.gf('django_iban.fields.IBANField')(default='', max_length=34, blank=True),
                      keep_default=False)

        # Adding field 'RecurringDirectDebitPayment.bic'
        db.add_column(u'fund_recurringdirectdebitpayment', 'bic',
                      self.gf('django_iban.fields.SWIFTBICField')(default='', max_length=11, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecurringDirectDebitPayment.iban'
        db.delete_column(u'fund_recurringdirectdebitpayment', 'iban')

        # Deleting field 'RecurringDirectDebitPayment.bic'
        db.delete_column(u'fund_recurringdirectdebitpayment', 'bic')
