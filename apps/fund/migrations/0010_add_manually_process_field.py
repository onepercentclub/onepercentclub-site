...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecurringDirectDebitPayment.manually_process'
        db.add_column(u'fund_recurringdirectdebitpayment', 'manually_process',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecurringDirectDebitPayment.manually_process'
        db.delete_column(u'fund_recurringdirectdebitpayment', 'manually_process')
    ...
    models = {
        ...
        u'fund.donation': {
            ...
            'voucher': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'donations'", 'null': 'True', 'to': u"orm['fund.Voucher']"})
        },
        u'fund.order': {
