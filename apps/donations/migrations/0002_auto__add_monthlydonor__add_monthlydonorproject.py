...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'donations_monthlydonor', (
        ...
        db.send_create_signal(u'donations', ['MonthlyDonor'])

        # Adding model 'MonthlyDonorProject'
        db.create_table(u'donations_monthlydonorproject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('donor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['donations.MonthlyDonor'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
        ))
        db.send_create_signal(u'donations', ['MonthlyDonorProject'])


    def backwards(self, orm):
        # Deleting model 'MonthlyDonor'
        db.delete_table(u'donations_monthlydonor')

        # Deleting model 'MonthlyDonorProject'
        db.delete_table(u'donations_monthlydonorproject')
    ...
    models = {
        ...
        u'donations.monthlydonorproject': {
            'Meta': {'object_name': 'MonthlyDonorProject'},
            'donor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'to': u"orm['donations.MonthlyDonor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Project']"})
        },
