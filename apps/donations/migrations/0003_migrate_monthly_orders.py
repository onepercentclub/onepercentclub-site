...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for rec in orm['fund.RecurringDirectDebitPayment'].objects.all():
            donor = orm['donations.MonthlyDonor'].objects.create(
                user=rec.user,
            ...
            if orders.count():
                ...
                for don in order.donations.all():
                    donor_project = orm['donations.MonthlyDonorProject'].objects.create(
                        donor=donor,
                        project=don.project
                    )
                    donor_project.save()
    ...
    def backwards(self, orm):
        ...
        orm['donations.MonthlyDonor'].objects.delete()
        orm['donations.MonthlyDonorProject'].objects.delete()
