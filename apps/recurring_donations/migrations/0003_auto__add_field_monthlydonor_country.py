...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonthlyDonor.country'
        db.add_column(u'recurring_donations_monthlydonor', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Country'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MonthlyDonor.country'
        db.delete_column(u'recurring_donations_monthlydonor', 'country_id')
