...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BankTransaction.payout'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BankTransaction.payout'
        db.alter_column(u'accounting_banktransaction', 'payout_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payouts.Payout'], null=True))
