...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RemoteDocdataPayout.period_id'
        db.delete_column(u'accounting_remotedocdatapayout', 'period_id')

        # Deleting field 'RemoteDocdataPayout.total'
        db.delete_column(u'accounting_remotedocdatapayout', 'total')

        # Adding field 'RemoteDocdataPayout.payout_reference'
        ...
        # Adding field 'RemoteDocdataPayout.payout_date'
        ...
        # Adding field 'RemoteDocdataPayout.collected_amount'
        ...
        # Adding field 'RemoteDocdataPayout.payout_amount'
    ...
    def backwards(self, orm):
        # Adding field 'RemoteDocdataPayout.period_id'
        db.add_column(u'accounting_remotedocdatapayout', 'period_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'RemoteDocdataPayout.total'
        db.add_column(u'accounting_remotedocdatapayout', 'total',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'RemoteDocdataPayout.payout_reference'
        db.delete_column(u'accounting_remotedocdatapayout', 'payout_reference')

        # Deleting field 'RemoteDocdataPayout.payout_date'
        db.delete_column(u'accounting_remotedocdatapayout', 'payout_date')

        # Deleting field 'RemoteDocdataPayout.collected_amount'
        db.delete_column(u'accounting_remotedocdatapayout', 'collected_amount')

        # Deleting field 'RemoteDocdataPayout.payout_amount'
        db.delete_column(u'accounting_remotedocdatapayout', 'payout_amount')
    ...
    models = {
        ...
        u'accounting.remotedocdatapayout': {
            ...
            'payout_date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
