...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RemoteDocdataPayment.triple_deal_reference'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RemoteDocdataPayment.triple_deal_reference'
        db.alter_column(u'accounting_remotedocdatapayment', 'triple_deal_reference', self.gf('django.db.models.fields.PositiveIntegerField')())
