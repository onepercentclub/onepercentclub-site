...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RemoteDocdataPayment.remote_payout'
    ...
    def backwards(self, orm):
        # Deleting field 'RemoteDocdataPayment.remote_payout'
        db.delete_column(u'accounting_remotedocdatapayment', 'remote_payout_id')
