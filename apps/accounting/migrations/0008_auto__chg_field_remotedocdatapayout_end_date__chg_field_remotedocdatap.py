...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RemoteDocdataPayout.end_date'
        db.alter_column(u'accounting_remotedocdatapayout', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'RemoteDocdataPayout.payout_date'
        db.alter_column(u'accounting_remotedocdatapayout', 'payout_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'RemoteDocdataPayout.start_date'
        db.alter_column(u'accounting_remotedocdatapayout', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'RemoteDocdataPayout.end_date'
        db.alter_column(u'accounting_remotedocdatapayout', 'end_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'RemoteDocdataPayout.payout_date'
        db.alter_column(u'accounting_remotedocdatapayout', 'payout_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'RemoteDocdataPayout.start_date'
        db.alter_column(u'accounting_remotedocdatapayout', 'start_date', self.gf('django.db.models.fields.DateField')(default=None))
