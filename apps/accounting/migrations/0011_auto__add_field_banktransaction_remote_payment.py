...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BankTransaction.remote_payment'
    ...
    def backwards(self, orm):
        # Deleting field 'BankTransaction.remote_payment'
        db.delete_column(u'accounting_banktransaction', 'remote_payment_id')
