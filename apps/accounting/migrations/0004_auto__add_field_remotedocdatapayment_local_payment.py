...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RemoteDocdataPayment.local_payment'
    ...
    def backwards(self, orm):
        # Deleting field 'RemoteDocdataPayment.local_payment'
        db.delete_column(u'accounting_remotedocdatapayment', 'local_payment_id')
