...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BankTransaction.status'
        db.add_column(u'accounting_banktransaction', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'BankTransaction.status_remarks'
        ...
        # Adding field 'RemoteDocdataPayment.status'
        db.add_column(u'accounting_remotedocdatapayment', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'RemoteDocdataPayment.status_remarks'
    ...
    def backwards(self, orm):
        # Deleting field 'BankTransaction.status'
        db.delete_column(u'accounting_banktransaction', 'status')

        # Deleting field 'BankTransaction.status_remarks'
        db.delete_column(u'accounting_banktransaction', 'status_remarks')

        # Deleting field 'RemoteDocdataPayment.status'
        db.delete_column(u'accounting_remotedocdatapayment', 'status')

        # Deleting field 'RemoteDocdataPayment.status_remarks'
        db.delete_column(u'accounting_remotedocdatapayment', 'status_remarks')
