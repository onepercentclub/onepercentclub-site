...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.homepage'
        db.add_column(u'campaigns_campaign', 'homepage',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.homepage'
        db.delete_column(u'campaigns_campaign', 'homepage')
