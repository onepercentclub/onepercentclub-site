...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.updated'
        db.add_column(u'tasks_task', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'TaskFile.updated'
        db.add_column(u'tasks_taskfile', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'TaskMember.updated'
        db.add_column(u'tasks_taskmember', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.updated'
        db.delete_column(u'tasks_task', 'updated')

        # Deleting field 'TaskFile.updated'
        db.delete_column(u'tasks_taskfile', 'updated')

        # Deleting field 'TaskMember.updated'
        db.delete_column(u'tasks_taskmember', 'updated')
