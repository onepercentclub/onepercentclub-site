...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field members on 'Task'
        m2m_table_name = db.shorten_name(u'tasks_task_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm[u'tasks.task'], null=False)),
            ('taskmember', models.ForeignKey(orm[u'bb_tasks.taskmember'], null=False))
        ))
        db.create_unique(m2m_table_name, ['task_id', 'taskmember_id'])

        # Adding M2M table for field files on 'Task'
        m2m_table_name = db.shorten_name(u'tasks_task_files')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm[u'tasks.task'], null=False)),
            ('taskfile', models.ForeignKey(orm[u'bb_tasks.taskfile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['task_id', 'taskfile_id'])
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'files': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bb_tasks.TaskFile']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bb_tasks.TaskMember']", 'null': 'True', 'symmetrical': 'False'}),
