...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskMember.motivation'
        db.add_column(u'tasks_taskmember', 'motivation',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'TaskMember.comment'
        db.add_column(u'tasks_taskmember', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskMember.motivation'
        db.delete_column(u'tasks_taskmember', 'motivation')

        # Deleting field 'TaskMember.comment'
        db.delete_column(u'tasks_taskmember', 'comment')
