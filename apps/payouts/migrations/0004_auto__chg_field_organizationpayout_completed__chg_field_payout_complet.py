...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganizationPayout.completed'
        db.alter_column(u'payouts_organizationpayout', 'completed', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Payout.completed'
        db.alter_column(u'payouts_payout', 'completed', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'OrganizationPayout.completed'
        db.alter_column(u'payouts_organizationpayout', 'completed', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Payout.completed'
        db.alter_column(u'payouts_payout', 'completed', self.gf('django.db.models.fields.DateTimeField')(null=True))
