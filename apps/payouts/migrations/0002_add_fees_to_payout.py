...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payout.amount_raised'
        db.add_column(u'payouts_payout', 'amount_raised',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Payout.bank_fee'
        db.add_column(u'payouts_payout', 'bank_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Payout.psp_fee'
        db.add_column(u'payouts_payout', 'psp_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Payout.organization_fee'
        db.add_column(u'payouts_payout', 'organization_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Payout.amount_organization'
        db.add_column(u'payouts_payout', 'amount_organization',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Payout.amount_failed'
        db.add_column(u'payouts_payout', 'amount_failed',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2),
                      keep_default=False)


        # Changing field 'Payout.amount'
        db.alter_column(u'payouts_payout', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        payouts = orm.Payout.objects.all()
    ...
    def backwards(self, orm):
        # Deleting field 'Payout.amount_raised'
        db.delete_column(u'payouts_payout', 'amount_raised')

        # Deleting field 'Payout.bank_fee'
        db.delete_column(u'payouts_payout', 'bank_fee')

        # Deleting field 'Payout.psp_fee'
        db.delete_column(u'payouts_payout', 'psp_fee')

        # Deleting field 'Payout.organization_fee'
        db.delete_column(u'payouts_payout', 'organization_fee')

        # Deleting field 'Payout.amount_organization'
        db.delete_column(u'payouts_payout', 'amount_organization')

        # Deleting field 'Payout.amount_failed'
        db.delete_column(u'payouts_payout', 'amount_failed')


        # Changing field 'Payout.amount'
        db.alter_column(u'payouts_payout', 'amount', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'payouts.payout': {
            ...
            'amount_organization': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'amount_raised': ('django.db.models.fields.IntegerField', [], {}),
            'bank_fee': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'currency': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'description_line1': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'description_line2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'description_line3': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'description_line4': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'amount_failed': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_reference': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'organization_fee': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'planned': ('django.db.models.fields.DateField', [], {}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Project']"}),
            'psp_fee': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
