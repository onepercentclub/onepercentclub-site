...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Payout.currency'
        db.delete_column(u'payouts_payout', 'currency')

        # Adding field 'Payout.payout_rule'
        db.add_column(u'payouts_payout', 'payout_rule',
                      self.gf('django.db.models.fields.CharField')(default='five', max_length=20),
                      keep_default=False)

        # Adding field 'Payout.amount_raised'
        db.add_column(u'payouts_payout', 'amount_raised',
                      self.gf('apps.payouts.fields.MoneyField')(default=Decimal('0.00'), max_digits=12, decimal_places=2),
                      keep_default=False)
        ...
        db.rename_column(u'payouts_payout', 'amount', 'amount_payable')

        # Adding field 'Payout.amount_payable'
        db.alter_column(u'payouts_payout', 'amount_payable',
                      self.gf('apps.payouts.fields.MoneyField')(default=Decimal('0.00'), max_digits=12, decimal_places=2)
        )
        ...
        if not db.dry_run:
            ...
            # Update amounts for money fields
            for payout in payouts:
                payout.amount_raised /= Decimal('100.00')
                payout.organization_fee /= Decimal('100.00')
                payout.amount_payable /= Decimal('100.00')
                payout.save()

    def backwards(self, orm):
        # Adding field 'Payout.currency'
        db.add_column(u'payouts_payout', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='EUR', max_length=3),
                      keep_default=False)

        # Deleting field 'Payout.payout_rule'
        db.delete_column(u'payouts_payout', 'payout_rule')
        ...
        db.rename_column(u'payouts_payout', 'amount_payable', 'amount')

        # Adding field 'Payout.amount'
        db.alter_column(u'payouts_payout', 'amount',
