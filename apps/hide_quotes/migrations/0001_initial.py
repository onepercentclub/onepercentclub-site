...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quotes_quote', (
            ...
            ('segment', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quote_author', to=orm['members.Member'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quote_user', to=orm['members.Member'])),
    ...
    models = {
        ...
        u'quotes.quote': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quote_author'", 'to': u"orm['members.Member']"}),
            ...
            'segment': ('django.db.models.fields.CharField', [], {'max_length': '20', 'db_index': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'draft'", 'max_length': '20', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quote_user'", 'to': u"orm['members.Member']"})
        },
        u'taggit.tag': {
