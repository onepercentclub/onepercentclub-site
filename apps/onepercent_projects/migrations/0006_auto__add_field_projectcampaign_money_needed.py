...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCampaign.money_needed'
        db.add_column(u'projects_projectcampaign', 'money_needed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCampaign.money_needed'
        db.delete_column(u'projects_projectcampaign', 'money_needed')
