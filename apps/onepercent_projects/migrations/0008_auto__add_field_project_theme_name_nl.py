...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTheme.name_nl'
        db.add_column(u'projects_projecttheme', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(default='temp', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTheme.name_nl'
        db.delete_column(u'projects_projecttheme', 'name_nl')
