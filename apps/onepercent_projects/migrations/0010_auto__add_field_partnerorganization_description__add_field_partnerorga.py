...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerOrganization.description'
        db.add_column(u'projects_partnerorganization', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PartnerOrganization.image'
        db.add_column(u'projects_partnerorganization', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerOrganization.description'
        db.delete_column(u'projects_partnerorganization', 'description')

        # Deleting field 'PartnerOrganization.image'
        db.delete_column(u'projects_partnerorganization', 'image')
