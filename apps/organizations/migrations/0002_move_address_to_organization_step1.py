...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.address_line1'
        db.add_column(u'organizations_organization', 'address_line1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Organization.address_line2'
        db.add_column(u'organizations_organization', 'address_line2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'organizations_organization', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='country', null=True, to=orm['geo.Country']),
                      keep_default=False)

        # Adding field 'Organization.postal_code'
        db.add_column(u'organizations_organization', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Organization.address_line1'
        db.delete_column(u'organizations_organization', 'address_line1')

        # Deleting field 'Organization.address_line2'
        db.delete_column(u'organizations_organization', 'address_line2')
        ...
        db.delete_column(u'organizations_organization', 'country_id')

        # Deleting field 'Organization.postal_code'
        db.delete_column(u'organizations_organization', 'postal_code')
