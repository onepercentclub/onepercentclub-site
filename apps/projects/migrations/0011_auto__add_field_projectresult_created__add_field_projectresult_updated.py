...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectResult.created'
        db.add_column(u'projects_projectresult', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'ProjectResult.updated'
        db.add_column(u'projects_projectresult', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectResult.created'
        db.delete_column(u'projects_projectresult', 'created')

        # Deleting field 'ProjectResult.updated'
        db.delete_column(u'projects_projectresult', 'updated')
