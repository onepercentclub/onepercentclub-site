...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCampaign.payout_date'
        db.add_column(u'projects_projectcampaign', 'payout_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCampaign.payout_date'
        db.delete_column(u'projects_projectcampaign', 'payout_date')
