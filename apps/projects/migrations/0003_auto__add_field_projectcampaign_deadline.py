...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCampaign.deadline'
        db.add_column(u'projects_projectcampaign', 'deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCampaign.deadline'
        db.delete_column(u'projects_projectcampaign', 'deadline')
