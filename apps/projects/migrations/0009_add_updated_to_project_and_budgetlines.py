...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectBudgetLine.created'
        db.add_column(u'projects_projectbudgetline', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=timezone.now, blank=True),
                      keep_default=False)

        # Adding field 'ProjectBudgetLine.updated'
        db.add_column(u'projects_projectbudgetline', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=timezone.now, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ProjectBudgetLine.created'
        db.delete_column(u'projects_projectbudgetline', 'created')

        # Deleting field 'ProjectBudgetLine.updated'
        db.delete_column(u'projects_projectbudgetline', 'updated')
