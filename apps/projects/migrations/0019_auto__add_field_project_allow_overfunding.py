...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.allow_overfunding'
        db.add_column(u'projects_project', 'allow_overfunding',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.allow_overfunding'
        db.delete_column(u'projects_project', 'allow_overfunding')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'allow_overfunding': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
