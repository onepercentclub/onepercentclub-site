...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectBudgetLine.currency'
        db.alter_column(u'projects_projectbudgetline', 'currency', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'ProjectBudgetLine.currency'
        db.alter_column(u'projects_projectbudgetline', 'currency', self.gf('django.db.models.fields.CharField')(max_length=10))
