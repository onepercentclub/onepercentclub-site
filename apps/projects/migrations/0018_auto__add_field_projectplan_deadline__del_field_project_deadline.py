...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectPlan.deadline'
        db.add_column(u'projects_projectplan', 'deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Project.deadline'
        db.delete_column(u'projects_project', 'deadline')


    def backwards(self, orm):
        # Deleting field 'ProjectPlan.deadline'
        db.delete_column(u'projects_projectplan', 'deadline')

        # Adding field 'Project.deadline'
        db.add_column(u'projects_project', 'deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
